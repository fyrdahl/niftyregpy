...
def aladin(ref, flo, noSym=None, regOnly=None, affDirect=None, aff=None, inaff=None, rmask=None, fmask=None, res=None, maxit=None, ln=None, lp=None, smooR=None, smooF=None, refLowThr=None, refUpThr=None, floLowThr=None, floUpThr=None, nac=None, cog=None, interp=None, iso=None, pv=None, pi=None, speeeeed=None, omp=None, verbose=True):
...
def f3d(ref=None, flo=None, aff=None, incpp=None, cpp=None, res=None, rmask=None, smooR=None, smooF=None, rLwTh=None, rUpTh=None, fLwTh=None, fUpTh=None, sx=None, sy=None, sz=None, be=None, le=None, l2=None, jl=None, noAppJL=None, nmi=None, rbn=None, fbn=None, lncc=None, ssd=None, kld=None, amc=None, maxit=None, ln=None, lp=None, nopy=None, noConj=None, pert=None, vel=None, fmask=None, omp=None, mem=None, gpu=None, smoothGrad=None, pad=None, verbose=True):
    
    """
    Fast Free-Form Deformation algorithm for non-rigid registration. This implementation is a re-factoring of Daniel Rueckert' 99 TMI work. The code is presented in Modat et al., "Fast Free-Form Deformation using graphics processing units", CMPB, 2010
    Cubic B-Spline are used to deform a source image in order to optimise a objective function based on the Normalised Mutual Information and a penalty term. The penalty term could be either the bending energy or the squared Jacobian determinant log.
...
def transform(ref, flo, trans, res=None, blank=None, inter=None, pad=None, tensor=None, psf=False, verbose=False):
    """
...
def average(output, avg=None, avg_lts=None, avg_tran=None, demean1=None, demean2=None, demean3=None, version=None):
    ...
    if avg is not None:
        if not any(isinstance(x, np.ndarray) for x in avg):
            ...
            pipe = sp.Popen(shlex.split(cmd_str), stdout=sp.PIPE, stderr=sp.PIPE)
...
def tools(input, output=None, float=None, down=None, smoS=None, smoG=None, smoL=None, add=None, sub=None, mul=None, div=None, rms=None, bin=None,thr=None, nan=None, iso=None, noscl=None, version=None, verbose=False):
